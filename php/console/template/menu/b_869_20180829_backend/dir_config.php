...
return [
    [
       'menu_name'  =>'招聘系统管理', 	//菜单名称
        'menu_url'   =>'zp-manage',  	//菜单路由
        'menu_type'  =>'1', 	    //菜单类型 1普通类 2视图类（如果是普通类，可不配置此字段）
        'parent_url' =>'', 	      //父级菜单路由
        'role_type'  => CommonConstant::ROLE_TYPE_ADD,        //角色类型 add新增角色 reduce减少角色 recover覆盖角色
        'role'       =>[
