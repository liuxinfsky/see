        ...
        <div>
          <Card>
            <Row>
              ...
              <Col span="6">
                <DatePicker type="datetimerange" :options="dateOption" @on-change="dateChange" @on-clear="dateClear" placement="bottom-end" placeholder="选择日期范围" style="width: 200px; float:right"></DatePicker>
              </Col>
            </Row>  
            </br>
            <Row>
...
<script>
  import {GetSqlList, SqlAction} from '@/api/sql/slowqueryrecord'
      ...
      return {
        ...
        columnsSqlList: [
...

          {
            ...
            render: (h, params) => {
              return h('div', [
                h('span', {}, this.$route.params.sqlid),
              ])
            }
          },

          {
            ...
            render: (h, params) => {
              return h('div', [
                h('span', {}, params.row.ReturnRowCounts),
              ])
            }
          },
...

          {
...

           {
            ...
            render: (h, params) => {
              return h('div', [
                h('span', {}, params.row.ExecutionStartTime),
              ])
            }
          },

           {
            ...
            render: (h, params) => {
              return h('div', [
                h('span', {}, params.row.ParseRowCounts),
              ])
            }
          },
          ...
          //     }
          //     var ddItem = [ 
          //         h('div' , {}, [h(Poptip,{props:{confirm:true, placement:popcss.place, width:popcss.width, transfer:true, title:'执行 此工单(' + id + ') ？'}, on:{'on-ok': () => {this.handleAction('execute', params)} } }, [h(DropdownItem, {}, '转化为工单')] ) ]) ,
          //     ]
